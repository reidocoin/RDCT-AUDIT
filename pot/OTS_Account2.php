 ...
 */
    public function load($id)
    {
	   ...
	   SELECT 
			' . $this->db->fieldName('id') . ', 
			' . $this->db->fieldName('name') . ', 
			' . $this->db->fieldName('senha') . ', 
			' . $this->db->fieldName('email') . ', 
			' . $this->db->fieldName('ativo') . ', 
			' . $this->db->fieldName('lastlogin') . ', 
			'. $this->db->fieldName('acesso') . ', 
			'. $this->db->fieldName('equipe') . ', 
			' . $this->db->fieldName('ramal') . ',
			' . $this->db->fieldName('foto') . ', 
			' . $this->db->fieldName('cargo') . ' 
		FROM 
			' . $this->db->tableName('usuarios') . ' 
		WHERE 
			' . $this->db->fieldName('id') . ' = ' . (int) $id)->fetch();
    }
